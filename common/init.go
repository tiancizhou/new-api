...
func InitEnv() {
	...
	EmployeeUsageRateLimitEnable = GetEnvOrDefaultBool("EMPLOYEE_USAGE_RATE_LIMIT_ENABLE", true)
	EmployeeUsageRateLimitNum = GetEnvOrDefault("EMPLOYEE_USAGE_RATE_LIMIT", 1000)
	EmployeeUsageRateLimitDuration = int64(GetEnvOrDefault("EMPLOYEE_USAGE_RATE_LIMIT_DURATION", 60))
